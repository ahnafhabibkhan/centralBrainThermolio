...
def bootstrap(admin_url, runtime_url, migrator_url, database="central_brain", remote=False):
    ...
    with psycopg.connect(db_url, autocommit=True) as connection:
        ...
        for name in ("001_core.sql", "003_pilot.sql", "004_library.sql", "005_library_deletions.sql", "006_library_copies.sql", "007_transfer_reservations.sql"):
        ...
        connection.execute("GRANT INSERT, DELETE ON central_brain.transfer_reservations TO central_brain_runtime")
