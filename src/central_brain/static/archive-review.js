document.addEventListener('submit', async event => {
  ...
  signin.hidden = true;
  status.textContent = data.get('action') === 'reject' ? 'Rejecting this archive.' : 'Approving this archive.';
  try {
    ...
    status.textContent = result.status === 'rejected' ? 'Archive rejected. Returning to your library.' : 'Archive approved. Returning to your library.';
